...
| A-05.1 | Auth hardening slice: requireEmailVerification, cookieCache, session TTLs, CORS allowedHeaders/maxAge, auth schema, baseURL host in toWebRequest | AHMAD | IN-PROGRESS(ahmad/auth-hardening) | A-05 | Deferred review minors (D-025 item 3) |
