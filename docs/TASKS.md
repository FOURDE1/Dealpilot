...
| F-02 | Lead intake → lead list: webhook/manual lead creation → leads appear in the store's list → status change. AHMAD half: /api/v1 leads routes + intake endpoint vs A-03 contract on RLS db. HUSSEIN half: leads screens on the shell. | BOTH | BACKLOG | F-01, A-06 | PROPOSED by AHMAD 2026-07-24 (the original F-01 alternative, now unblocked — orgs+stores exist). OWNER: confirm to start. |
