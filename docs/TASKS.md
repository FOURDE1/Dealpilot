...
| A-07 | AWS IaC baseline + first deploy, minimal-footprint cost ramp | AHMAD | CLAIMED(AHMAD, 2026-07-24) | A-01, A-02 | ROADMAP 0.7 (incl. staging RDS db.t4g.small Single-AZ, VPC-private — D-013); every apply needs owner approval |
